...
<body>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <!--  Inicio - Navbar (Barra de navegação do Site)-->
            ...
            <label for="BemVindoUser">
                <img src="../imagens/usericon.png" width="42" height="42">Seja bem-vindo adm!
            </label>
                ...
                if ($j != 3 && strcasecmp($linha['descStatusNoticia'], 'Desativado')) {
                    if ($j == 0) { ?>
                        ...
                        <?php } else { ?>
                            ...
                            <?php } ?>
                            <img class="d-block w-100 imagem-style" src=" <?php echo $linha['fotoNoticia'] ?>" height="300" width="300">
                ...
                <tbody>
                    ...
                    foreach ($listanoticia as $linha) {
                        ...
                        if (strcasecmp($linha['descStatusNoticia'], 'Desativado')) { ?>
                                ...
                                <td class="td-style">
                                    <figure>
                                        <img src='<?php echo $linha['fotoNoticia'] ?>' width='200' heigth='200'>
                                    </figure>
